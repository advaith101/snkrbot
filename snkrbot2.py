...
def run_single_instance(entity, mode="banner", model=None, size=None, productID=None, captcha_mode='solve'):
    ...
    human_type(st_address[0], entity["shipping_stinfo"])
    wait_between(MIN_RAND, MAX_RAND)
    human_like_mouse_move(driver)
    ...
    time.sleep(1)
    actions = ActionChains(driver)
    human_type(actions, entity["card_no"])
    actions.perform()
    ...
    time.sleep(1)
    actions = ActionChains(driver)
    human_type(actions, entity["card_exp_mm"])
    actions.perform()
    wait_between(MIN_RAND, MAX_RAND)
    human_like_mouse_move(driver)
    ...
    time.sleep(1)
    actions = ActionChains(driver)
    human_type(actions, entity["card_exp_yy"])
    actions.perform()
    wait_between(MIN_RAND, MAX_RAND)
    human_like_mouse_move(driver)
    ...
    time.sleep(1)
    actions = ActionChains(driver)
    human_type(actions, entity["card_pin"])
    actions.perform()
    wait_between(MIN_RAND, MAX_RAND)
    human_like_mouse_move(driver)
